...
describe('focus-trap-implemented', () => {
  ...
  it('should have id "focus-trap-implemented"', () => {
    expect(focusTrapImplemented.id).toBe('focus-trap-implemented');
  });

  describe('valid focus trap → pass', () => {
    it('should pass when dialog has role, aria-modal, aria-labelledby, and focusable elements', () => {
      document.body.innerHTML = `
      ...
      const result = focusTrapImplemented.validate(document);

      expect(result.passed).toBe(true);
    });

    it('should pass when dialog uses aria-label instead of aria-labelledby', () => {
      document.body.innerHTML = `
    ...
    it('should pass with a native <dialog> element', () => {
      document.body.innerHTML = `
    ...
    it('should pass when dialog contains multiple focusable elements', () => {
      document.body.innerHTML = `
    ...
    it('should pass when focusable element uses tabindex', () => {
      document.body.innerHTML = `
  ...
  describe('missing dialog → fail', () => {
    it('should fail when no dialog element exists', () => {
      document.body.innerHTML = `
        <div class="modal">
          <button>Close</button>
        </div>
  ...
  describe('missing aria-modal → fail', () => {
    it('should fail when dialog lacks aria-modal="true"', () => {
      document.body.innerHTML = `
  ...
  describe('missing accessible name → fail', () => {
    it('should fail when dialog has no aria-label or aria-labelledby', () => {
      document.body.innerHTML = `
    ...
    it('should fail when aria-labelledby references a non-existent element', () => {
      document.body.innerHTML = `
  ...
  describe('no focusable elements → fail', () => {
    it('should fail when dialog contains no focusable elements', () => {
      document.body.innerHTML = `
    ...
    it('should not count disabled buttons as focusable', () => {
      document.body.innerHTML = `
    ...
    it('should not count tabindex="-1" as focusable', () => {
      document.body.innerHTML = `
        <div role="dialog" aria-modal="true" aria-label="Dialog">
